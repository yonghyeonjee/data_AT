...
- **관심 품목은 견적서 품목표와 같은 24개 (v136 · 2026-09-21)** — "혼수/입주/이사 vs 구독 vs 일시불마다 상담 입력과 견적서가 달라져야 한다" 논의의 첫 조각. 담당자 화면 `CATS` 가
  TV·사운드바·벽걸이·후드·냉동고·냉장고·김치냉장고·페어킷·세탁기·건조기·에어드레서·슈드레서·에어컨·식기세척기·인덕션·오븐(큐커)·공기청정기·로봇청소기(구독)·무선청소기 제트·무빙스타일·정수기(구독)·밥솥·제습기·기타·알 수 없음 (옛 11개 대분류 `세탁·건조`·`주방가전`·`입주패키지` 등은 뺐다 — 옛 상담의 값은 그대로 남아 통계에 그 이름으로 보인다).
